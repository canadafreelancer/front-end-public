  ...
  return (
    <div className={styles["container"]}>
      ...
      <div className={styles["content_container"]}>
        <p>
          {myMenus === "Employers" && <h1>The possibilites are endless</h1>}
        </p>
        <p>
          {myMenus === "Employers" && (
            <p className={styles["first_paragraph"]}>
              {" "}
              We have expert freelancers who work in every
        ...
        <div className={styles["employeer_first_section"]}>
          ...
          <div className={styles["column-2"]}>
            ...
            {myMenus === "Freelancers" && (
              <RiNumber1 className={styles["services_number"]} />
            )}
            {myMenus === "Freelancers" && (
              <h2 className={styles["first_heading"]}>
                Complete and set up your profile
              </h2>
            )}
            {myMenus === "Freelancers" && (
              <p>
                Select your skills or expertise and upload a professional photo
                and recieve competitive bids from freelancers within minutes.
              </p>
            )}
            {myMenus === "Freelancers" && (
              <RiNumber2 className={styles["services_number"]} />
            )}
            {myMenus === "Freelancers" && (
              <h2 className={styles["heading-2"]}>
                Browse jobs that suits you
              </h2>
            )}
            {myMenus === "Freelancers" && (
              <p>
                {" "}
                Here we have jobs available for all skills and expertise levels.
                Save your search and recieve alerts when jobs are available .
              </p>
            )}
            {myMenus === "Freelancers" && (
              <RiNumber3 className={styles["services_number"]} />
            )}
            {myMenus === "Freelancers" && (
              <h2 className={styles["heading-3"]}>Submit a decent proposal</h2>
            )}
            {myMenus === "Freelancers" && (
              <p>
                Simply put your best foot foward and write the best bid possible
                by Reading the project and let the clients know you are fit for
                it.
              </p>
            )}
            {myMenus === "Freelancers" && (
              <RiNumber4 className={styles["services_number"]} />
            )}
            {myMenus === "Freelancers" && (
              <h2 className={styles["heading-3"]}>
                Earn and get paid for work{" "}
              </h2>
            )}
            {myMenus === "Freelancers" && (
              <p>
                Get ready to work as soon as you get hired. Deliver high quality
                and recieve planned payments from client after completion.
              </p>
            )}
            {myMenus === "Freelancers" && (
              <button className={styles["button_freelancer"]}>Apply now</button>
            )}
          </div>
        </div>
        <div
          className={styles["image_wrapper"]}
          id={styles["employeer_first_section"]}>
        ...
        <div className={styles["paragraph_wrapper"]}>
          {myMenus === "Employers" && (
            <p>Get any job done. from small scale to large scale projects</p>
          )}
          {myMenus === "Employers" && (
            <p>
              Make fixed payments or pay hours. All secured by etransfer payment
              system
            </p>
          )}
          {myMenus === "Employers" && (
            <p>
              Access expert freelancers with over 1800 skill set around the
              world
            </p>
          )}
        </div>
        <div className={styles["second_section"]}>
          <div className={styles["COL_1"]}>
            ...
            {myMenus === "Employers" && (
              <p>
                Simply make a job post or project post on what you need done and
                recieve competitive bids from freelancers within minutes.
              </p>
            )}
            {myMenus === "Employers" && (
            ...
            {myMenus === "Employers" && (
              <h2 className={styles["heading-2"]}>
                Choose the perfect talent for the job
              </h2>
            )}
            {myMenus === "Employers" && (
              <p>
            ...
            {myMenus === "Employers" && (
              <h2 className={styles["heading-3"]}>Pay when you're satisfied</h2>
            )}
            {myMenus === "Employers" && (
              <p>
                Simply make a job post or project post on what you need done and
            ...
            <div className={styles["free_section"]}>
              <div className={styles["sec_1"]}>
                ...
                {myMenus === "Freelancers" && (
                  <p>
                    CanadaFreelancers is a community that values your safety as
                    our number 1 piority.
                  </p>
                )}
                ...
                <div className={styles["second_head_wrapper"]}>
                  ...
                  {myMenus === "Freelancers" && (
                    <h1> Bringing Canada freelancers together</h1>
                  )}
                </div>
              </div>
...
const MenuImage = ({ src }) => {
  return <Image src={src} alt="" width={53} height={48} layout="fixed" />;
};
...
const MenuImage4 = ({ src }) => {
  return <Image src={src} alt="" width={550} height={550} layout="fixed" />;
};
const MenuImage5 = ({ src }) => {
  return <Image src={src} alt="" width={50} height={50} layout="fixed" />;
};
const MenuImage6 = ({ src }) => {
  return <Image src={src} alt="" width={50} height={50} layout="fixed" />;
};
const MenuImage7 = ({ src }) => {
  return <Image src={src} alt="" width={510} height={500} layout="fixed" />;
};
const MenuImage8 = ({ src }) => {
  return <Image src={src} alt="" width={50} height={50} layout="fixed" />;
};
const MenuImage9 = ({ src }) => {
  return <Image src={src} alt="" width={55} height={54} layout="fixed" />;
};
const MenuImage10 = ({ src }) => {
  return <Image src={src} alt="" width={400} height={400} layout="fixed" />;
};
