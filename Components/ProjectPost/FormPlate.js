    ...
    <div className={styles["parent-container"]}>
      <div className={styles["container"]}>
        <div className={styles["container-control"]}>
          <h3>Project Name</h3>
          <input type="text" className={styles["form-con"]} placeholder="Enter Project title" />
          </div>
          ...
          <div className={styles["form-group"]}>
            ...
            <input type="text" className={styles["form-group-1"]} placeholder="UI/UX, Web Design, Andriod Developer"/>
            <p>Enter skills for needed for project</p>
          </div>

          <div className={styles["pricing-type"]}>
          <h3>Pricing Type</h3>
          <select className={styles["select-pricing"]}>
            <option className={styles["option"]}>Select</option>
